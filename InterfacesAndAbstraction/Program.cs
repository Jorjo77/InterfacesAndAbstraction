...
namespace InterfacesAndAbstraction
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Ако имаме наследяване след двете точки пирво се записва класа, а след него със запетайка интерфейса/интерфейсите(ако са повече) и имплементираме.
            ...
            //Разликата между abstract и virtual метод/пропирти е че abstract се имплементира задължително, а virtual се override и има default стойност!!!
